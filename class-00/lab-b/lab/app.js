...
// this is the object that in references
// 2. What is "this" when joe.scopeArrow() is invoked?
//this is the window object
// 3. Explain why "this" is different when an arrow function is used.
// because when you use this with the arrow functionality it does not exist as a key word for arrow fucntions so it defaults to the window
