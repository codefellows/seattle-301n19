...
function displayPics(){
  ...
  // Here, let is scoped to a code block. Because we are trying to console log it outside of the while loop, rando is showing up as not defined. It works when we use var because we are console logging it in the function (where it is declared).
  console.log(viewed);
