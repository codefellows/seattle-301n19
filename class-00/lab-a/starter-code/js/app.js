...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: The reason I think it threw the error was because it doesnt recognize the variable rando due to the let, js doesn't know it. and rando is assigned to makeRandom()
  console.log(viewed);
